...
var CanvasParticleWay = /** @class */ (function (_super) {
    ...
    CanvasParticleWay.prototype.drawPassage = function () {
        if (!this.passage)
            return;
        if (!_super.prototype.points)
            return;
        if (_super.prototype.points.length <= 1)
            return;
        var isBezier = _super.prototype.points[1].length === 6;
        var g = this.passage.graphics;
        g.clear();
        g.ss(1).beginStroke(this.passageColor);
        _super.prototype.points.forEach(function (p, index) {
            if (index === 0) {
                g.mt(p[0], p[1]);
                return;
            }
    ...
    Object.defineProperty(CanvasParticleWay.prototype, "points", {
        set: function (points) {
            _super.prototype.points = points;
            this.drawPassage();
        },
        enumerable: false,
        configurable: true
